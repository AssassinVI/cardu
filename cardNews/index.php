                   ...
                   <div class="col-md-12 col">
                    <div class="cardshap brown_tab mouseHover_other_tab">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link  py-2 pl-0 flex-x-center active show" id="goodTicket-tab"  href="new_card_second.php" tab-target="#goodTicket" aria-selected="true"><i class="icon" style="background-image: url(&quot;file:///C:/Users/User/icon/Documents/index/../img/component/icon/icon8.png&quot;); background-size: 63%;"></i> 新卡訊</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link py-2 pl-0 flex-x-center" id="goodSet-tab" href="new_card_second.php" tab-target="#goodSet" aria-selected="false"><i class="icon" style="background-image: url(&quot;file:///C:/Users/User/icon_down/Documents/index/../img/component/icon_down/icon9.png&quot;);"></i> 權益變更</a>
                          </li>
                        </ul>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active  pl-30 py-2" id="box-tab"  href="second.php" tab-target="#box" aria-selected="true">懶人包</a>
                          </li>
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link py-2" id="open-tab"  href="second.php" tab-target="#open" aria-selected="false">開卡文</a>
                          </li>
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link py-2" id="share-tab"  href="second.php" tab-target="#share" aria-selected="false">愛分享</a>
                          </li>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab">
                            <a class="nav-link active  pl-30 py-2" id="title_1-tab"  href="second.php"  tab-target="#title_1" aria-selected="true">卡訊</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="title_2-tab"  href="second.php"  tab-target="#title_2" aria-selected="false">首刷禮</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="title_3-tab"  href="second.php"  tab-target="#title_3" aria-selected="false">購物</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="title_4-tab"  href="second.php"  tab-target="#title_4" aria-selected="false">美食</a>
                          </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="tab-pane fade" id="title_4" role="tabpanel" aria-labelledby="title_4-tab">
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab">
                            <a class="nav-link active pl-30 py-2" id="title_5-tab" href="second.php" tab-target="#title_5" aria-selected="true">旅遊</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="title_6-tab" href="second.php" tab-target="#title_6" aria-selected="false">交通</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="title_7-tab" href="second.php" tab-target="#title_7" aria-selected="false">電影</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="title_8-tab" href="second.php" tab-target="#title_8" aria-selected="false">休閒</a>
                          </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
