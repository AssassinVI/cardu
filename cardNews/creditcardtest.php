                        ...
                        <div class="row pt-3 mx-3 detail_title">
                          ...
                          <h2>
                           ...
                           <div class="col-md-4">
                            ...
                            <div class="col-md-6"><span><i class="fa fa-check-circle"></i></span>網路消費2.5%現金回饋 </div>
                            <div class="col-md-6"><span><i class="fa fa-check-circle"></i></span>一般消費紅利2倍</div>
                            <div class="col-md-6"><span><i class="fa fa-check-circle"></i></span>3期分期0利率</div>
                            <div class="col-md-6"><span><i class="fa fa-check-circle"></i></span>首次自動加值OPENPOINT點數 </div> 
                            <div class="col-md-6"><span><i class="fa fa-check-circle"></i></span>首次自動加值OPENPOINT點數 </div> 
                          </div> 
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab">
                            <a class="nav-link active pl-30 py-2" id="special_1-tab" data-toggle="tab" href="#special_1" role="tab" aria-controls="special_1" aria-selected="true">重要權益</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="special_2-tab" data-toggle="tab" href="#special_2" role="tab" aria-controls="special_2" aria-selected="false">全部權益</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="special_3-tab" data-toggle="tab" href="#special_3" role="tab" aria-controls="special_3" aria-selected="false">資訊內容</a>
                          </li>
                          <li class="nav-item news_tab">
                            <a class="nav-link py-2" id="special_4-tab" data-toggle="tab" href="#special_4" role="tab" aria-controls="special_4" aria-selected="false">網友留言</a>
                          </li>
                        </ul>
                              ...
                              <div class="card">
                                <div class="card-header hv-center" id="imp_int1">
                                  <div class="row w-h-100">
                                    ...
                                    <div class="col-md-8 v-center border-left border-right">
