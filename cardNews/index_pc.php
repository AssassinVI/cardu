                   ...
                   <div class="col-md-12 col">
                    <div class="cardshap brown_tab mouseHover_other_tab">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link  py-2 pl-0 flex-x-center active show" id="goodTicket-tab"  href="new_card_second.php" tab-target="#goodTicket" aria-selected="true"><i class="icon"></i> 新卡訊</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link py-2 pl-0 flex-x-center" id="goodSet-tab" href="new_card_second.php" tab-target="#goodSet" aria-selected="false"><i class="icon"></i> 權益變更</a>
                          </li>
                        </ul>
                      ...
                      foreach ($row_news_type as $news_type) {
                       ...
                       $list_txt.= '
                        <li class="nav-item news_tab">
                          <a class="nav-link '.$active.' pl-30 py-2" id="special_'.$x.'-tab"  href="second.php?mt_pk='.$news_type['Tb_index'].'" tab-target="#special_'.$x.'" aria-selected="true">'.$news_type['nt_name'].'</a>
                        </li>';
                       ...
                       for ($i=0; $i <2 ; $i++) { 
                                ...
                                for ($j=0; $j <3 ; $j++) { 
                                  ...
                                  $news_txt.='
                                  <div class="col-4 cards-3">
                                    <a href="detail.php?'.$row_news_con[$index]['Tb_index'].'">
                      ...
                      foreach ($row_news_type as $news_type) {
                       ...
                       $list_txt.= '
                        <li class="nav-item news_tab news_tab_three">
                          <a class="nav-link '.$active.' pl-30 py-2" id="card_'.$x.'-tab"  href="second.php?mt_pk='.$news_type['Tb_index'].'" tab-target="#card_'.$x.'" aria-selected="true">'.$news_type['nt_name'].'</a>
                        </li>';
                    ...
                    <?php 
                      ...
                      foreach ($row_news_type as $news_type) {
                       ...
                       $list_txt.= '
                        <li class="nav-item news_tab ">
                          <a class="nav-link '.$active.' pl-30 py-2" id="message1_'.$x.'-tab"  href="second.php?mt_pk='.$news_type['Tb_index'].'" tab-target="#message1_'.$x.'" aria-selected="true">'.$news_type['nt_name'].'</a>
                        </li>';
                    ...
                    <?php 
                      ...
                      foreach ($row_news_type as $news_type) {
                       ...
                       $list_txt.= '
                        <li class="nav-item news_tab ">
                          <a class="nav-link '.$active.' pl-30 py-2" id="message2_'.$x.'-tab"  href="second.php?mt_pk='.$news_type['Tb_index'].'" tab-target="#message2_'.$x.'" aria-selected="true">'.$news_type['nt_name'].'</a>
                        </li>';
