               ...
               <div class="row">
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          ...
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link py-2" id="title_6-tab" data-toggle="tab" href="#title_6" role="tab" aria-controls="title_6" aria-selected="false">金融卡</a>
                          </li>
                          <li class="nav-item news_tab news_tab_three">
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="tab-pane fade show active" id="special_1" role="tabpanel" aria-labelledby="special_1-tab">
                            ...
                            <div class="row no-gutters px-md-2 py-md-3 px-2 py-3 bankbg_list">
                              ...
                              <div class="col-md-8  col-12 card_list_txt">
                                <div class="bank_list">
