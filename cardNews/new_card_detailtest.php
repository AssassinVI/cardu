                    ...
                    <div class="col-md-12 col">
                      ...
                      <div class="cardshap ">
                        <div class="pt-3 mx-3 detail_title">
                          ...
                          <div class="row no-gutters my-3 newcard_g">
                            <div class="col-md-6 col-12"><span><i class="fa fa-check-circle"></i> </span>網路消費2.5%現金回饋 </div>
                            <div class="col-md-6 col-12"><span><i class="fa fa-check-circle"></i> </span>一般消費紅利2倍</div>
                            <div class="col-md-6 col-12"><span><i class="fa fa-check-circle"></i> </span>3期分期0利率</div>
                            <div class="col-md-6 col-12"><span><i class="fa fa-check-circle"></i> </span>首次自動加值OPENPOINT點數 </div> 
                          </div> 
                        </div>
