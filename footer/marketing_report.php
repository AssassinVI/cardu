  ...
  <body class="news_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="index.php">首頁</a> / <a href="about.php">行銷合作</a></p>
          </div>
        </div>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab">
                            <a class="nav-link active pl-30 py-2" id="title_5-tab" href="javascript:;" tab-target="#title_5" aria-selected="true">行銷合作</a>
                          </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="title_5" role="tabpanel" aria-labelledby="title_5-tab">
                           ...
                           <form class="px-md-2 login_info">
                             ...
                             <p><span class="about_info">您好，若想詢問行銷合作相關資訊，敬請填寫下列表單送出，卡優新聞網將有專人與您聯繫，感謝您！</span></p>
