  ...
  <body class="point_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="index.php">首頁</a> / <a href="point.php">優集點</a> / <a href="point_all.php">集點平台</a> / <a href="javascript:;">悠遊卡</a></p>
          </div>
        </div>
                        ...
                        <div class="pt-3 detail_title">
                         <div class="col-md-12 col">
                            <div class="row ticketbg2">
                              ...
                              <img class="h-center" src="../img/component/uupon2.png" title="新聞">
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_5-tab" data-toggle="tab" href="#title_5" role="tab" aria-controls="title_5" aria-selected="true">平台介紹</a>
                          </li>
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link py-2" id="title_6-tab" data-toggle="tab" href="#title_6" role="tab" aria-controls="title_6" aria-selected="false">集點攻略</a>
                          </li>
                          <li class="nav-item news_tab news_tab_three">
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="title_5" role="tabpanel" aria-labelledby="title_5-tab">
                                ...
                                <p>悠遊卡是一種非接觸式電子票證系統智慧卡，由悠遊卡公司發行，首先於2002年6月通用於臺北捷運。目前發行張數7千多萬張，悠遊卡可用於搭乘大臺北地區交通運輸工具、停車場、醫院、動物園、圖書館等處使用。</p>
                              
                                <p><b>悠遊卡使用範圍</b><br>
                                1.點選Wallet 功能，加入信用卡或金融卡服務。<br>
                                2.點選右上+新增卡片，依步驟加入卡片，Apple Pay會自動辨識卡號及持卡人姓名。<br>
                                3.發卡銀行與機構，會進一步認證所輸入的資料是否正確，並進行個資身分查驗。想查詢持有卡資訊，請返回「設定」>「Wallet 與 Apple Pay」>「卡片」。<br>
                                4.銀行與發卡機構完成驗證後，iPhone 即可使用 Apple Pay 付款服務。</p>
                        ...
                        <div class="row no-gutters pb-md-3 pb-2 news_list">
