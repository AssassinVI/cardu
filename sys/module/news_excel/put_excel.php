<?php 
  ...
  header('Content-Disposition: attachment; filename='.$_POST['StartDate'].'至'.$_POST['EndDate'].'之新聞資料.xls'); //設定檔案名稱
   ...
   <table border="1" cellpadding="5" cellspacing="0">
   	  ...
   	  <tbody>
          ...
          foreach ($row as $row_one) {
            ...
            //-- 上架期間 --
            $row_time=pdo_select("SELECT StartDate, EndDate FROM appNews WHERE Tb_index=:Tb_index", ['Tb_index'=>$row_one['Tb_index']]);
          ...
          <td>'.$row_time['StartDate'].'~'.$row_time['EndDate'].'</td>
