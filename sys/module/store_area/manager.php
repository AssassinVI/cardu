...
if ($_POST) {
  ...
  $OrderBy=pdo_select("SELECT OrderBy FROM store_type ORDER BY OrderBy DESC LIMIT 0,1", 'no');
  ...
  $OnLineOrNot=empty($_POST['OnLineOrNot']) ? 0:1;
	...
	pdo_update('store_type', $param, $where);
...
if ($_GET) {
 	...
 	$row=pdo_select('SELECT * FROM store_type WHERE Tb_index=:Tb_index', $where);
				...
				<div class="panel-body">
					<form id="put_form" action="manager.php" method="POST" enctype='multipart/form-data' class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="st_name"><span class="text-danger">*</span>商店類別</label>
							<div class="col-md-10">
