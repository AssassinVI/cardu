...
if ($_GET) {
   ...
   //-- 主分類 --
   $store_type_main=pdo_select("SELECT mt_id, st_name FROM store_type_main WHERE Tb_index=:Tb_index ", ["Tb_index"=>$_GET['second_id']]);

   //-- 商店分類 --
   $store_type=pdo_select("SELECT mt_id, st_name FROM store_type WHERE Tb_index=:Tb_index ", ["Tb_index"=>$store_type_main['mt_id']]);

   
   //-- 次分類 --
   $sql=$pdo->prepare("SELECT * FROM store_type_second WHERE mt_id=:mt_id ORDER BY OrderBy ASC");
   $sql->execute( ["mt_id"=>$_GET['second_id']] );
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
		    ...
		    <li>
		    	<a href="admin_main.php?MT_id=<?php echo $_GET['MT_id'];?>&main_id=<?php echo $store_type_main['mt_id'];?>"><?php echo $store_type['st_name']; ?> </a>
		    </li>
		    <li>
		    	<a href="javascript:;"><?php echo $store_type_main['st_name']; ?></a>
		    </li>
		</ol>

		<h2 class="text-primary"><?php echo $store_type_main['st_name']?> 列表</h2>
	   ...
	   <div class="new_div">
	    ...
	    <a href="manager_second.php?MT_id=<?php echo $_GET['MT_id'];?>&second_id=<?php echo $_GET['second_id'];?>">
					...
					<table class="table table-hover">
						...
						?>
							<tr>
								...
								<a href="manager_second.php?MT_id=<?php echo $_GET['MT_id']?>&second_id=<?php echo $_GET['second_id'];?>&Tb_index=<?php echo $row['Tb_index'];?>" >
