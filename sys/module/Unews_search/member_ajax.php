...
$columns = array(
    ...
    array(
        ...
        'formatter' => function( $d, $row ) {
            ...
            return '            
                                <a href="javascript:;" onclick="window.open(\'../Unews_public/newsView_windows.php?Tb_index='.$d.'\', \''.$row_name['ns_ftitle'].'\', config=\'height=800,width=900\');" class="btn btn-rounded btn-default btn-sm">
