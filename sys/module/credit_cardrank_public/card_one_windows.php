     ...
     $('#search_btn').click(function(event) {
          ...
          if (err_txt!='') {
           alert("請輸入"+err_txt+"!!");
            ...
            var card_name=$('#select_bank :selected').html()+$('#select_card :selected').html()+$('#select_card_level :selected').html();
            $("#ccs_cc_cardname",parent.document).val(card_name);

            $('[name="ccs_cc_bi_pk"]',parent.document).val($('[name="ccs_cc_bi_pk"]').val());
            $('[name="ccs_cc_pk"]',parent.document).val($('[name="ccs_cc_pk"]').val());
            $('[name="ccs_cc_group_id"]',parent.document).val($('[name="ccs_cc_group_id"]').val());
            $('[name="ccs_cc_cardlevel"]',parent.document).val($('[name="ccs_cc_cardlevel"]').val());
            $('[name="ccs_cc_cardlvname"]',parent.document).val($('[name="ccs_cc_cardlvname"]').val());
