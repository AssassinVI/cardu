              ...
              success:function (data) {
                ...
                $.each(data, function(index, val) {
                  ...
                  if (card_name_arr[0]!=undefined) {
                    var check_card=card_id_arr.indexOf(this['cc_group_id'])==-1 ? '':'checked';
                  }
                  else{
                    var check_card='';
                  }
                  ...
                  var txt='<tr>'+
                             ' <td><input type="checkbox" '+check_card+' name="ccard_name" card_id="'+this['cc_group_id']+'" value="'+$('#select_bank :selected').html()+this['cc_cardname']+'"></td>'+
