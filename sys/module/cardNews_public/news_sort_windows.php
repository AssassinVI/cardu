...
<?php 
  ...
  $row=$NewPdo->select("SELECT nt_name, ns_ftitle, ns_viewcount, ns_mobvecount, ns_fbcount, ns_verify, StartDate, EndDate, activity_s_date, activity_e_date,
							  ...
							  <?php 
                                foreach ($row as $row_one) {
                                  ...
                                  if ($row_one['activity_s_date']=='0000-00-00' && $row_one['activity_e_date']=='0000-00-00') {
                                    ...
                                    $activity_s_date=$row_one['activity_s_date']=='0000-00-00' ? '即日起至':$row_one['activity_s_date'];
                                    $activity_s_e_date=$activity_s_date.' ~ '.$row_one['activity_e_date'];
                                  }
