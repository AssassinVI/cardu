					...
					<table class="table no-margin">
						...
						<?php 
							...
							<tr>
								...
								<a href="javascript:;" onclick="window.open('../Unews_public/newsView_windows.php?Tb_index=<?php echo $row['Tb_index'];?>', '<?php echo $row['ns_ftitle']; ?>', config='height=800,width=900');" class="btn btn-rounded btn-default btn-sm">
