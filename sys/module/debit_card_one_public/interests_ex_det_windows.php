...
<?php 
  $row=$NewPdo->select("SELECT ".$_GET['td_name']." FROM debit_card_eq WHERE bank_id=:bank_id AND eq_id=:eq_id GROUP BY ".$_GET['td_name']." ORDER BY Tb_index DESC", ['bank_id'=>$_GET['bank_id'], 'eq_id'=>$_GET['eq_id']]);
?>
