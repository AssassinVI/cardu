...
if ($_POST) {
  ...
  $OrderBy=pdo_select("SELECT OrderBy FROM news_type WHERE mt_id=:mt_id AND area_id=:area_id AND nt_sp='1' ORDER BY OrderBy DESC LIMIT 0,1", ['mt_id'=>$_POST['mt_id'], 'area_id'=>$_POST['area_id']]);
