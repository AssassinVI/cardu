...
if ($_POST) {
  ...
  if ($_POST['ns_verify']==2) {
	...
	location_up('../Unews/manager_view.php?MT_id='.$_POST['mt_id'].'&Tb_index='.$Tb_index,'');
   }
            ...
            <div class="form-group">
              ...
              <div class="col-md-2">
                ...
                <input type="hidden" name="nt_sp_id" value="">
						...
						<input type="hidden" id="mt_id" name="mt_id" value="site2019011116122890">
