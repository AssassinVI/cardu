...
<?php 
  $row=$NewPdo->select("SELECT * FROM credit_card_eq WHERE bank_id=:bank_id AND eq_id=:eq_id GROUP BY group_id ORDER BY Tb_index DESC", ['bank_id'=>$_GET['bank_id'], 'eq_id'=>$_GET['eq_id']]);
?>
