...
if ($_POST) {
  ...
  //-- 新聞銀行/組織關聯儲存 END --
	...
	location_up('../cardNews/manager_view.php?MT_id='.$_POST['mt_id'].'&Tb_index='.$Tb_index,'');
}
	...
	<div class="row">
		<div class="col-lg-12">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10 row">
                <div class="col-md-5">
                  <input type="text" class="form-control datepicker_range from" id="StartDate" name="StartDate" value="<?php echo date('Y-m-d');?>">
                </div>
                                <div class="col-md-1"><h3>至</h3></div>
                <div class="col-md-5">
                  <input type="text" class="form-control datepicker_range to" id="EndDate" name="EndDate" value="<?php echo date('Y-m-d', strtotime('+1 month'));?>">
                </div>
                <div class="col-md-1"><h3>止</h3></div>
                <div class="col-md-12">
                  ...
                  if (!empty($row['ns_label'])) {
                    for ($i=0; $i <count($ns_label) ; $i++) { 
                       echo '<span class="label">'.$ns_label[$i].'<input type="hidden" name="ns_label[]" value="'.$ns_label[$i].'"></span>、';
						...
						<input type="hidden" id="mt_id" name="mt_id" value="site2019011115571667">
