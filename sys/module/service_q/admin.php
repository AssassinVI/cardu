...
<style type="text/css">
    #table_id_example_length{display: none;}
    .fancybox-slide--iframe .fancybox-content {width  : 800px;max-width  : 800px;max-height : 100%;margin: 0;}
</style>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table id="table_id_example" class="display">
						<thead>
							<tr>
								<th class="nowrap">服務項目</th>
								<th class="nowrap">頻道</th>
								<th style="max-width: 500px;">主題</th>
								<th>發送時間</th>
								<th>處理狀態</th>
								<th>回覆者</th>
                <th>回覆時間</th>
