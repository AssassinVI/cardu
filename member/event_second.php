...
<html lang="zh-Hant-TW">
  <head>
    ...
    ?>
    <meta property="og:site_name" content="卡優新聞網-會員中心 > 卡優活動" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="zh_TW" />
    <meta property="og:title" content="卡優新聞網-會員中心 > 卡優活動" />
  ...
  <body class="member_body">
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="member.php">會員中心</a> / <a href="javascript:;">卡優活動</a></p>
          </div>
        </div>
                        ...
                        <div class="" id="myTabContent">
                          <div class="tab-pane fade show active" id="title_5" role="tabpanel" aria-labelledby="title_5-tab">
                           ...
                           $row_list_total=$pdo->select("SELECT COUNT(*) as total
                                                         FROM appNotice 
                                                         WHERE note_type=1 AND OnLineOrNot=1"
                                                         , 'no', 'one');
                           $total_page=ceil(((int)$row_list_total['total'])/$num);
                            ...
                            foreach ($row_annouce as $list_one) {
                             ...
                             $url=$URL.'/member/event_activity_detail.php?'.$list_one['Tb_index'];
