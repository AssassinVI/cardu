<?php 
 ...
 $prev_news=$pdo->select("SELECT * 
                          FROM appNotice 
                          WHERE Tb_index>:Tb_index AND note_type=0 AND OnLineOrNot=1
 ...
 $prev_url='notify_detail.php?'.$prev_news['Tb_index'];
 $next_url='notify_detail.php?'.$next_news['Tb_index'];
?>
<!DOCTYPE html>
...
<html lang="zh-Hant-TW">
  <head>
    ...
    <meta name="keywords" content="<?php echo $row['aTitle']; ?>,卡優公告"/>  
  ...
  <body class="member_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/member/member.php">會員中心</a> / <a href="annouce_second.php">卡優公告</a></p>
          </div>
        </div>
                      ...
                      <div class="cardshap">
                        <div class="pt-3 mx-3 detail_title">
                          ...
                          <div class="row no-gutters my-3">
                            ...
                            <div class="col-md-8">
                               <h4></h4>
                               <p>公告時間：<?php echo $row['StartDate']; ?>~<?php echo $row['EndDate']; ?></p>
                            </div>
                            <div class="col-md-4">
                                <!-- 分享 -->
                               <?php 
