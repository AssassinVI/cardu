  ...
  <body class="member_body">
    ...
    <div class="container">
       ...
       ?>
        ...
        <div class="row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="index.php">首頁</a> / <a href="point.php">會員中心</a> / <a href="javascript:;">我的信用卡
            </a></p>
          </div>
        </div>
                ...
                <div class="row">
                   <!--我的信用卡-->
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_5-tab"  href="second.php" tab-target="#title_5" aria-selected="true">我的信用卡
                            </a>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_5-tab"  href="second.php" tab-target="#title_5" aria-selected="true">我的信用卡_新聞
                            </a>
                            <a class="top_link" href="all.php"></a>
                          </li>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_6-tab"  href="second.php" tab-target="#title_6" aria-selected="true">我的信用卡_卡情報
                            </a>
                            <a class="top_link" href="all.php"></a>
                          </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="title_6" role="tabpanel" aria-labelledby="title_6-tab">
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_7-tab"  href="second.php" tab-target="#title_7" aria-selected="true">我的信用卡_優行動Pay
                            </a>
                            <a class="top_link" href="all.php"></a>
                          </li>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_8-tab"  href="second.php" tab-target="#title_8" aria-selected="true">我的信用卡_優票證
                            </a>
                            <a class="top_link" href="all.php"></a>
                          </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="title_8" role="tabpanel" aria-labelledby="title_8-tab">
                    ...
                    <div class="col-md-12 col">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab news_tab_three">
                            <a class="nav-link active pl-30 py-2" id="title_9-tab"  href="second.php" tab-target="#title_9" aria-selected="true">我的信用卡_優集點
                            </a>
                            <a class="top_link" href="all.php"></a>
                          </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="title_9" role="tabpanel" aria-labelledby="title_9-tab">
                    ...
                    <div class="col-12 page">
                      <span>第1頁( 共5頁 )</span>
                      <i class="fa fa-angle-left"></i>上一頁</a>
                      <select>
                      ...
                      下一頁 <i class="fa fa-angle-right"></i></a>
                    </div>
