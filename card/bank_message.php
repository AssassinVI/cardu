...
<html lang="zh-Hant-TW">
  <head>
    ...
    <title>卡優新聞網-<?php echo $row_bank_one['bi_shortname'];?>相關好康</title>
    ...
    ?>
    <meta property="og:site_name" content="卡優新聞網-<?php echo $row_bank_one['bi_shortname'];?>相關好康" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="zh_TW" />
    <meta property="og:title" content="卡優新聞網-<?php echo $row_bank_one['bi_shortname'];?>相關好康" />
  ...
  <body class="cardNews_body">
    ...
    <div class="container">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="card.php">卡情報</a> / <a href="bank_list.php">銀行總覽</a> / <a href="bank_detail.php?bi_pk=<?php echo $_GET['bi_pk'] ;?>"><?php echo $row_bank_one['bi_shortname']; ?></a> / <a href="javascript:;">相關好康</a>
            </p>
          </div>
        </div>
