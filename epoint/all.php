...
<html lang="zh-Hant-TW">
  <head>
    ...
    ?>
    <meta property="og:site_name" content="卡優新聞網-優集點 > 點數平台" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="zh_TW" />
    <meta property="og:title" content="卡優新聞網-優集點 > 點數平台" />
  ...
  <body class="point_body">
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/epoint/epoint.php">優集點</a> / <a href="javascript:;">點數平台</a></p>
          </div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col">
                    ...
                    <?php } ?>
                        ...
                        <?php 
                         //----- 商店 -----
                         $row_pay=$pdo->select("SELECT * FROM store where st_type='st2019013117014249' and OnLineOrNot=1 order by st_name");
