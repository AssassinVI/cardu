...
<html lang="zh-Hant-TW">
  <head>
    ...
    <title>卡優新聞網- 優集點 > <?php echo $nt_name; ?></title>
    ...
    ?>
    <meta property="og:site_name" content="卡優新聞網- 優集點 > <?php echo $nt_name; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="zh_TW" />
    <meta property="og:title" content="卡優新聞網- 優集點 > <?php echo $nt_name; ?>" />
  ...
  <body class="point_body">
    ...
    <div class="container">
       ...
       <?php 
        ...
        <div class="row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/epoint/epoint.php">優集點</a> / <a href="javascript:;"><?php echo $nt_name?></a></p>
          </div>
        </div>
