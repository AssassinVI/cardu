               ...
               <div class="content_tab">
                ...
                <?php 
                 ...
                 $row_hot_news=$pdo->select("SELECT Tb_index, ns_photo_1, ns_ftitle, ns_msghtml 
                                             FROM appNews 
                                             WHERE ns_nt_pk='nt2019011818241680' 
                 ...
                 $row_hot_news2=$pdo->select("SELECT Tb_index, ns_photo_1, ns_ftitle, ns_msghtml 
                                              FROM appNews 
                                              WHERE ns_nt_pk='nt2019011818242292' 
                                              ORDER BY ns_fwdate DESC LIMIT 0,1");
                ...
                <form class="row search_from" action="search_result.php" method="GET">
                    ...
                    <div class="col-9">
                      <select name="store_type">
                          ...
                          <option value="platform">點數平台</option>
                          <option value="store">集點店家</option>
                          <?php 
                            // $row_pay=$pdo->select("SELECT Tb_index, st_name FROM store WHERE st_type='st2019013117014249' AND OnLineOrNot=1 ORDER BY OrderBy, StartDate DESC");
                      ...
                      <select name="nt_id">
                          ...
                          <?php 
                            $row_nt=$pdo->select("SELECT Tb_index, nt_name FROM news_type WHERE area_id='at2019011117443626' AND OnLineOrNot=1 AND nt_sp=0 ORDER BY OrderBy");
