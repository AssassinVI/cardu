          ...
          <div class="col-12">
            <?php 
             ...
             if (empty($row_store_one['st_main_type'])) {
               echo '<p class="crumbs">
                        <i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="epoint.php">優集點</a> / <a href="all.php">點數平台</a> / <a href="about.php?'.$row_store_one['Tb_index'].'">'.$row_store_one['st_nickname'].'</a> / <a href="javascript:;">相關新聞</a>
                     </p>';
             }
             else{
              echo '<p class="crumbs">
                        <i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="epoint.php">優集點</a> / <a href="all2.php">集點店家</a> / <a href="about2.php?'.$row_store_one['Tb_index'].'">'.$row_store_one['st_nickname'].'</a> / <a href="javascript:;">相關新聞</a>
                     </p>';
             }
            ?>
