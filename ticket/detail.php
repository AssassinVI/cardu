  ...
  <body class="ticket_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="index.php">首頁</a> / <a href="ticket.php">優票證</a> / <a href="ticket_second.php">購物</a></p>
          </div>
        </div>
                      ...
                      <div class="cardshap ">
                        ...
                        <h2>Android Pay支付　快樂購點數限時送</h2>
                          <div class="row no-gutters my-3">
                            ...
                            <div class="col-8">
                              <a><img src="../img/component/pay.png"> </a><p>活動時間： 20XX/XX/XX~20XX/XX/XX</p>
                            </div>
