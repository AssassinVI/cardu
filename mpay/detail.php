...
if (!$temparray[1]) {
  location_up('back','好像有東西出錯了唷，請回上一頁');
    ...
    if (empty($row['Tb_index'])) {
     location_up('../member/my404.php?mpay','');
     exit();
    }
    ...
    $mt_pk =empty($row_pk['pk']) ? $row_pk['Tb_index'] : $row_pk['pk'];
...
<html lang="zh-Hant-TW">
  <head>
    ...
    <meta name="keywords" content="<?php echo $row['ns_ftitle']; ?>,<?php echo $nt_name; ?>,優行動pay"/>  
  ...
  <body class="pay_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="mpay.php">優行動Pay</a> / <a href="list.php?mt_pk=<?php echo $mt_pk;?>"><?php echo $nt_name;?></a></p>
          </div>
        </div>
