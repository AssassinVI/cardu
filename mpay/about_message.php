  ...
  <body class="pay_body">
    ...
    <div class="container">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/mpay/mpay.php">優行動Pay</a> / <a href="all.php">Pay總覽</a> / <a href="about.php?<?php echo $row_store_one['Tb_index'];?>"><?php echo $row_store_one['st_nickname'];?></a> / <a href="javascript:;">相關好康</a>
            </p>
          </div>
        </div>
