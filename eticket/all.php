...
<html lang="zh-Hant-TW">
  <head>
    ...
    ?>
    <meta property="og:site_name" content="卡優新聞網-優票證 > 票證總攬" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="zh_TW" />
    <meta property="og:title" content="卡優新聞網-優票證 > 票證總攬" />
  ...
  <body class="ticket_body">
    ...
    <div class="container">
       ...
       <?php 
        ...
        <div class="row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/eticket/eticket.php">優票證</a> / <a href="javascript:;">票證總覽</a></p>
          </div>
        </div>
            ...
            <div class="index-content-left col0">
                ...
                <div class="row">
                  ...
                  <?php 
                    ...
                    //----- 商店 -----
                    $row_pay=$pdo->select("SELECT * FROM store where st_type='st201901311701269' and OnLineOrNot=1 order by st_name");
