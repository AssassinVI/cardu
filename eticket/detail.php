...
if (!$temparray[1]) {
  location_up('back','好像有東西出錯了唷，請回上一頁');
    ...
    if (empty($row['Tb_index'])) {
     location_up('../member/my404.php?eticket','');
     exit();
    }
  ...
  <body class="ticket_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/eticket/eticket.php">優票證</a> / <a href="javascript:;"><?php echo $nt_name;?></a></p>
          </div>
        </div>
                ...
                <div class="row">
                        ...
                        <h2><?php echo $row['ns_ftitle'];?></h2>
                          <div class="row no-gutters my-3">
                            ...
                            <?php 
                             ...
                             $store_txt=$store_num==1 ? '<a target="_blank" title="'.$row_store[0]['st_nickname'].'" href="about.php?'.$row_store[0]['Tb_index'].'">
                    ...
                    <?php }else{ ?>
                     ...
                     <div class="col-md-12 col">
                         ...
                         <div class="cardshap pink_tab phone_hidden">
                         <ul class="nav nav-tabs" id="myTab" role="tablist">
                           <li class="nav-item news_tab">
