<?php 
 ...
 $row_store_one=$pdo->select("SELECT st_nickname, Tb_index FROM store WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['store_id']], 'one');
?>
<!DOCTYPE html>
...
<html lang="zh-Hant-TW">
  <head>
    ...
    <title>卡優新聞網-<?php echo $row_store_one['st_nickname'];?>相關新聞</title>
    ...
    ?>
    <meta property="og:site_name" content="卡優新聞網-<?php echo $row_store_one['st_nickname'];?>相關新聞" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="zh_TW" />
    <meta property="og:title" content="卡優新聞網-<?php echo $row_store_one['st_nickname'];?>相關新聞" />
  ...
  <body class="ticket_body">
    ...
    <div class="container">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/index.php">首頁</a> / <a href="/eticket/eticket.php">優票證</a> / <a href="all.php">票證總覽</a> / <a href="about.php?<?php echo $row_store_one['Tb_index'];?>"><?php echo $row_store_one['st_nickname'];?></a> / <a href="javascript:;">相關新聞</a>
            </p>
          </div>
        </div>
                      ...
                      <div class="cardshap ">
                       ...
                       <?php 
                        ...
                        $row_list_total=$pdo->select("SELECT count(*) as total
                                                FROM NewsAndType
                                                WHERE ns_verify=3 AND OnLineOrNot=1 AND StartDate<=:StartDate AND EndDate>=:EndDate AND
                        ...
                        foreach ($row as $row_one) {
                          ...
                          $small_txt=$store_num==1 ? '<small class="cs_small"><a href="/eticket/about.php?'.$row_store[0]['Tb_index'].'">('.$row_store[0]['st_nickname'].')</a></small>' : '';
