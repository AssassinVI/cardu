               ...
               <div class="content_tab">
                ...
                <?php 
                 ...
                 $row_hot_news=$pdo->select("SELECT Tb_index, ns_photo_1, ns_ftitle, ns_msghtml 
                                             FROM appNews 
                                             WHERE ns_nt_pk='nt2019011818222043' 
                 ...
                 $row_hot_news2=$pdo->select("SELECT Tb_index, ns_photo_1, ns_ftitle, ns_msghtml 
                                              FROM appNews 
                                              WHERE ns_nt_pk='nt2019011818222944' 
                                              ORDER BY ns_fwdate DESC LIMIT 0,1");
                        ...
                        <div class="swiper-slide" > 
                          <?php 
                           ...
                           foreach ($row_hot_news as $hot_news) {
                            ...
                            $ns_msghtml=mb_substr(myTrim(strip_tags($hot_news['ns_msghtml'])), 0,20, 'utf-8');
                            //-- 判斷網址 --
                            $news_url=$x==2 || $x==3 ? 'ad.php?'.$hot_news['Tb_index'] : '../eticket/detail.php?'.$hot_news['Tb_index'];
                            //-- 判斷廣告圖片 --
                ...
                <form class="row search_from" action="search_result.php" method="GET">
                    ...
                    <div class="col-9">
                      <select name="store_id">
                          ...
                          <?php 
                            $row_pay=$pdo->select("SELECT Tb_index, st_name FROM store WHERE st_type='st201901311701269' AND OnLineOrNot=1 ORDER BY OrderBy, StartDate DESC");
                      ...
                      <select name="nt_id">
                          ...
                          <?php 
                            $row_nt=$pdo->select("SELECT Tb_index, nt_name FROM news_type WHERE area_id='at2019011117435970' AND OnLineOrNot=1 AND nt_sp=0 ORDER BY OrderBy");
