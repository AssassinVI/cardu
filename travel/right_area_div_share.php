               ...
               <div class="content_tab">
                 <div class="journey_icon">
                   <div class="row no-gutters">
                    ...
                    <?php 
                     $row_tr_type=$pdo->select("SELECT nt_name, Tb_index FROM news_type WHERE unit_id='un2019011717563437' AND OnLineOrNot=1 ORDER BY OrderBy ASC");
                     foreach ($row_tr_type as $tr_type) {
                       echo '
                       <div class="col-6 py-2 border-bottom">
                         <a href="share.php?tr_pk='.$tr_type['Tb_index'].'"> <i class="fa fa-arrow-circle-right mr-2"></i>'.$tr_type['nt_name'].'</a>
                       </div>';
                     }
                    ?>
