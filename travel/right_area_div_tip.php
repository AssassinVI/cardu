                  ...
                  <ul class="tab_list cardu_li">
                    <?php 
                     ...
                     $row_hot_news=$pdo->select("SELECT  n.Tb_index, n.mt_id, n.ns_nt_pk, n.area_id, n.ns_ftitle
                                                 ...
                                                 WHERE n.unit_id='un2019011717570690' AND n.ns_vfdate<>'0000-00-00 00:00:00' AND n.ns_verify=3 
                                                 AND  n.StartDate<=:StartDate AND n.EndDate>=:EndDate AND OnLineOrNot=1 AND nct.ack_click_date >=:day_ago
                                                 GROUP BY n.Tb_index
