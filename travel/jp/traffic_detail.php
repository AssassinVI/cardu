...
<?php 
 ...
 $title_name='卡優新聞網-日本嬉遊趣 > '.$row_nt['nt_name'].'交通';
 $crumbs_name='<a href="about.php?tr_pk='.$row_nt['Tb_index'].'">'.$row_nt['nt_name'].'</a> / <a href="javascript:;">'.$row_nt['nt_name'].'交通</a>';
?>
<!DOCTYPE html>
                    ...
                    <div class="col-md-12 col">
                      ...
                      <div class="cardshap text-center">
                        ...
                        <div class="pb-3 mx-3 detail_content">
                         ...
                         <?php
                         require 'data/recomm_02_04_'.$pk.'_detail.php';
                         ?>
