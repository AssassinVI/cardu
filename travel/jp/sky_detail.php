...
<?php 
 ...
 $title_name='卡優新聞網-日本嬉遊趣 > 飛往'.$row_nt['nt_name'];
 $crumbs_name='<a href="about.php?tr_pk='.$row_nt['Tb_index'].'">'.$row_nt['nt_name'].'</a> / <a href="javascript:;">飛往'.$row_nt['nt_name'].'</a>';
?>
<!DOCTYPE html>
            ...
            <div class="index-content-left detail_page col0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col">
                      ...
                      <div class="cardshap text-center">
                        

                        <div class="pb-3 mx-3 detail_content">
                          <?php
                          require 'data/recomm_02_03_'.$pk.'_detail.php';
                          ?>
