  ...
  <body class="pay_body">
    ...
    <div class="container detail_page">
        ...
        <div class="row crumbs_row">
          <div class="col-12">
            <p class="crumbs"><i class="fa fa-angle-right"></i> <a href="/">首頁</a> / <a href="/pay/">優行動Pay</a> / <a href="javascript:;"><?php echo $nt_name?></a></p>
          </div>
        </div>
            ...
            <div class="index-content-left detail_page col0">
                ...
                <div class="row">
                          ...
                          <div class="row no-gutters my-3">
                            ...
                            <div class="col-md-4 col-12">
                               <div class="search_div hv-center">
                                <div class="fb-like mr-2" data-href="http://srl.tw/cardu/news_detail.html" data-layout="box_count" data-action="like" data-size="small" data-show-faces="true" data-share="false" title="新聞"></div>
                    ...
                    <div class="col-md-12 col">
                        ...
                        <div class="cardshap blueGreen_tab phone_hidden">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item news_tab">
