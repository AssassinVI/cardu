                       ...
                       <div class="cardshap blueGreen_tab">
                         ...
                         <div class="col-md-4 col">
                           <div class="cardshap pay-4 pb-2">
                             <a href="#" title="apply pay">
                               <img src="../img/component/pay/apple pay.png">
                             <h3>apple pay</h3>
                             </a>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4 col">
                          <div class="cardshap pay-4 pb-2">
                            <a href="#" title="samsung pay">
                               <img src="../img/component/pay/samsung pay.png">
                            <h3>samsung pay</h3>
                            </a>
                         </div>
                       </div>
                        ...
                        <div class="col-md-4 col">
                          <div class="cardshap pay-4 pb-2">
                            <a href="#" title="android pay">
                               <img src="../img/component/pay/andriod pay.png">
                            <h3>android pay</h3>
                            </a>
                         </div>
                       </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="tab-pane fade" id="goodSet" role="tabpanel" aria-labelledby="goodSet-tab">
                            ...
                            <div class="row no-gutters">
                              <div class="col-4 cards-3">
                                <a href="#">
                                 <div class="img_div" title="新聞" style="background-image: url(../img/component/photo2.jpg);"></div>
                                  <p>遊日血拚大回饋，信用卡大調查</p>
                                </a>
                              </div>
                              <div class="col-4 cards-3">
