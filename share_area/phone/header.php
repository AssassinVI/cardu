           ...
           <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
             <div class="card-body">
               <div class="row no-gutters">
                 ...
                 <div class="col-6"><a href="#">科技</a></div>
                 <div class="col-6"><a href="#">消費</a></div>
                 <div class="col-6"><a href="#">休閒</a></div>
                 <div class="col-6"><a href="#">萬象</a></div>
               </div>
             </div>
           </div>
         </div>
         <div class="card">
           ...
           <div id="collapse2" class="collapse " aria-labelledby="card2" data-parent="#accordionExample">
             <div class="card-body">
               ...
               <h4>人氣排行</h4>
               <div class="row no-gutters">
                 <div class="col-6"><a href="#">新卡人氣排行</a></div>
                 <div class="col-6"><a href="#">辦卡人氣排行</a></div>
                 <div class="col-6"><a href="#">點閱人氣排行</a></div>
               </div>

               <h4>卡比較</h4>
               <div class="row no-gutters">
                 <div class="col-6"><a href="#">新卡快搜</a></div>
                 <div class="col-6"><a href="#">卡片比一比</a></div>
                 <div class="col-6"><a href="#">權益比一比</a></div>
               </div>
             </div>
           </div>
         </div>
